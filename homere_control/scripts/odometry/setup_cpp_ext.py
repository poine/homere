...
ext = Extension(
    "cpp_homere_control",        # name of extension
    ["homere_control.pyx"],  # filename of our Pyrex/Cython source
    language="c++",    # this causes Pyrex/Cython to create C++ source
    include_dirs=["/home/poine/work/homere/homere_control/include"],
    extra_compile_args=["-std=c++11", "-Wno-cpp"],
    libraries=["homere_controller"],
    library_dirs=["/opt/ros/kinetic/lib/", "/home/poine/work/overlay_ws/devel/lib/"],
    runtime_library_dirs=[],
)

setup(
    name = 'cpp_homere_control',
    ext_modules = [ext],
