...
namespace homere_controller {
  ...
  void Publisher::init(ros::NodeHandle& root_nh, ros::NodeHandle& controller_nh) {
// Get and check params for covariances
  ...
  void Publisher::starting(const ros::Time& now) {
  ...
  void DebugPublisher::publish(const double lw_angle, const double rw_angle, const double lw_rvel, const double rw_rvel,
